...
import { Users, MessageSquareText, Clock, CheckCircle2, Eye, TrendingUp } from 'lucide-react'
import { AdminLayout } from '@/components/admin-layout'
import { getGuests, getAspirations, getVisitorStats, type Guest, type Aspiration, type VisitorStats } from '@/lib/store'

export default function DashboardPage() {
  const [guests, setGuests] = useState<Guest[]>([])
  const [aspirations, setAspirations] = useState<Aspiration[]>([])
  const [visitorStats, setVisitorStats] = useState<VisitorStats>({ totalVisits: 0, todayVisits: 0, lastVisitDate: '' })
