...
export default function SlideSettingsPage() {
  ...
  const handleReset = async () => {
    if (
      confirm(
        "Apakah Anda yakin ingin mengembalikan semua pengaturan slide ke default?",
      )
    ) {
      try {
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Kelola gambar dan keterangan slide landing page
            </p>
          </div>
            ...
            <div className="bg-card rounded-xl sm:rounded-2xl border border-border p-4 sm:p-5 lg:p-6 space-y-4 sm:space-y-5 lg:space-y-6 order-2 lg:order-1">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative">
                  {currentSlide.imageUrl ? (
                    ...
                    <button
                      onClick={() =>
                        fileInputRefs.current[activeSlide]?.click()
                      }
                  ...
                  <input
                    ref={(el) => {
                      fileInputRefs.current[activeSlide] = el;
                    }}
                    type="file"
                    accept="image/*"
                ...
                <p className="text-xs text-muted-foreground">
                  Gambar akan ditampilkan sebagai background dengan overlay
                  gradient
                </p>
              </div>
              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleSlideChange(currentSlide.id, "title", e.target.value)
                  }
                ...
                <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6">
                  <div className="text-center max-w-lg">
                    ...
                    <p className="text-xs sm:text-sm text-white/90 max-w-xs sm:max-w-md mx-auto text-pretty">
                      {currentSlide.description ||
                        "Deskripsi slide akan muncul di sini"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-4">
                  <div className="text-center">
                    ...
                    <h4 className="text-xs sm:text-sm font-bold text-white mt-1 line-clamp-2">
                      {slide.title}
                    </h4>
                  </div>
                </div>
